...
export default function CategoryChip({ icon, children }: CategoryChipProps) {
  return (
    <span className="crd-cristal-liquido-chip inline-flex items-center gap-[5px] whitespace-nowrap rounded-full px-[11px] py-[5px] font-label text-xs font-bold text-ink">
