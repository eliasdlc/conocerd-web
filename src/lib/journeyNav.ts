...
// por el "saltador" que el recorrido registra aquí: en escritorio es
// teletransporte + vuelo directo de cámara (jumpToScene), en móvil el motor de
// pasos. El fallback por id queda para anclas fuera del recorrido.
