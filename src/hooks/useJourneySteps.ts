...
//
//  En móvil el scroll libre es el enemigo del scrollytelling: un flick se salta
//  dos escenas, un scroll corto deja la cámara a medio vuelo y el usuario nunca
//  ve la composición encuadrada. Aquí el journey avanza de keyframe en keyframe
//  con una duración fija: cada paso empieza y termina exactamente donde el
//  encuadre está diseñado.
//
...
export function useJourneySteps({
  ...
  // Mientras este motor no conduce (desktop, o un salto de nav), el paso activo
  // es una proyección del progreso: así al cruzar el breakpoint el stepper ya
  // está en la escena correcta sin tener que resincronizar nada.
